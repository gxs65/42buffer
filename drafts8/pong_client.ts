...
import { Client_commands, Client_message, Server_message,
		 Game_state_description, Game_init_description, Dimensions, Game_close_description } from "./pong_interfaces.js";
...
class Pong_game
{
	...
	update_animation = () =>
	{
		...
		if (current_time - this.time_last_data_received > 1000)
