...
import { Vec2, vec2_add, vec2_slope_between_two_points, vec2_sproduct, vec2_symmetry, slope_on_circle } from "../shared/pong_utils.js";
// CONSTANTS
...
export class Paddle {
    constructor(game, index, simulation_tick_interval, initial_x, initial_y, width, height, speed) {
...
export class Ball {
    constructor(game, simulation_tick_interval, initial_x, initial_y, radius, initial_speed) {
