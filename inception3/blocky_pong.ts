...
class Paddle
{
	...
	process_keyevent(code: string)
	{
		let move_direction: 1 | -1;
		let key_released: boolean; // whether the key was released, or pressed
...
class Ball
{
	...
	speed: number = 0; // a scaler on the direction vector (#f)
	drawn: boolean;
	...
	update(): 0 | 1 | 2 // #f : use elapsed time
	{
