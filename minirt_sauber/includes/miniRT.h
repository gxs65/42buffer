...
/*   Updated: 2025/03/20 21:29:39 by abedin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
+ inclure les object cones
+ implementer les textures + bumper maps
+ implementer les surfaces miroir
- petites corrections du code :
	...
	\ permettre des commentaires plus faciles dans la scene / donner un resume des spes
- potentiellement
	\ retravailler l'illuminayion par modele de Phong (test quand on retire le parametre de distance)
	\ rectangles et parallelepipedes
	\ fuzzy reflection
	\ accompagner les textures d'une map de specular pour savoir sur quelles point appliquer la specular
...
- norminette sure les headers
- retirer variable globale de log, remplacer par une macro
- corriger le Makefile
- liberation de la memoire / robustesse a fichiers invalides
- autres textures que seulement la terre
