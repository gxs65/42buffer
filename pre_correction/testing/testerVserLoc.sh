...
echo "\n\n\033[33m=== GET REQUEST ON MAIN PAGE, HOST NOT DEFINED, IP NET, PORT 8080 (TARGET side2) ===\033[0m\n"
printf "GET /site/welcomepage.html HTTP/1.1\r\nHost:10.16.7.4:8080\r\n\r\n" | nc -N 10.16.7.4 8080
echo "\n\n\033[33m=== GET REQUEST ON MAIN PAGE, HOST NOT DEFINED, IP NET, PORT 8081 (TARGET side2) ===\033[0m\n"
printf "GET /site/welcomepage.html HTTP/1.1\r\nHost:10.16.7.4:8081\r\n\r\n" | nc -N 10.16.7.4 8081
echo "\n\n\033[33m=== GET REQUEST ON MAIN PAGE, HOST NOT DEFINED, IP LOCALHOST, PORT 8082 (TARGET side2) ===\033[0m\n"
printf "GET /site/welcomepage.html HTTP/1.1\r\nHost:localhost:8082\r\n\r\n" | nc -N 127.0.0.1 8082
