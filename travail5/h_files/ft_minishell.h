...
/*   Updated: 2025/01/21 01:49:42 by abedin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Custom error codes
// A) Codes for processes forked so that they execve a specific command,
// 	  they are used for information and processing of AND/OR nodes,
// 	  but will not make minishell exit/reprompt
// /!\ to respect rules on processes' exit status, codes are <256
// and (like in bash) have specific meaning for 126 and 127
// 		- code = 124 : error while trying to open redirection files
...
# define CMD_OPEN_ERROR				124
# define CMD_SYSCALL_ERROR			125
# define CMD_NOXRIGHT_ERROR			126
# define CMD_NOEXEC_ERROR			127
// B) Codes > 255, meaning minishell encountered an error in its main process
// 	  and must either reprompt or exit
// 		- 255 < KILL codes < 272  : fatal errors, cause minishell to exit
// 		- 271 < STOP codes        : non-fatal errors, cause minishell to reprompt
# define KILL_MALLOC_ERROR			256
# define KILL_SIGACTION_ERROR		257
# define KILL_ENVFORMAT_ERROR		258
# define KILL_OPENCWD_ERROR			259
# define KILL_FORK_ERROR			260
# define KILL_PIPE_ERROR			261
# define STOP_SYNTAX_ERROR			273
# define STOP_EMPTYLINE_ERROR		274
